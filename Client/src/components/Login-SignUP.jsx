...
const AuthForm = () => {
  ...
  return (
    ...
    >
      <div className="bg-white p-6 rounded-lg shadow-lg w-96 bg-opacity-90">
        ...
        <button className="w-full bg-blue-500 text-white p-2 rounded mb-2" onClick={isSignUp ? handleSignUp : handleSignIn}>
          {isSignUp ? "Sign Up" : "Sign In"}
        </button>
